...
const Lesson = () => {
    ...
    const hearts = hasFastForward ? 3 - incorrectAnswerCount : null;
    ...
    const fastForwardValue = url.searchParams.get("fast-forward");


    const unitNumber = Number(fastForwardValue);
    ...
    return (
        <header className="flex items-center gap-4">
            {correctAnswerCount === 0 ? (
                <Link to="/learn" className="text-gray-400">
                    <CloseSvg />
                ...
                <section className="flex max-w-2xl grow flex-col gap-5 self-center sm:items-center sm:justify-center sm:gap-24">
                    ...
                    <div className="w-full">
                        <div className="flex items-center gap-2 px-2">
                            <img src={womanPng} alt="" width={92} height={115} />
